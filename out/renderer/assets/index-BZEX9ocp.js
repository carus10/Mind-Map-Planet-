...
function WelcomeScreen({ onVaultSelected, scanning }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "welcome", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "welcome-title", children: "MindMap World" }),
...
function VoronoiMap({ hierarchy }) {
  ...
  const { nodeMap, parentMap } = reactExports.useMemo(() => {
    ...
    const traverse = (node, parentCountry) => {
  ...
  const planets = reactExports.useMemo(() => {
    ...
    const spreadFactor = baseRadius * 4.5;
    return countries.map((node, i) => {
      const childCount = node.children?.length || 0;
      const radius2 = baseRadius * (0.7 + 0.5 * Math.min(childCount / 15, 1));
      ...
      return { node, cx: cx2, cy: cy2, radius: radius2, colorSet };
    });
  ...
  const handleContextMenu = reactExports.useCallback((e, node) => {
    e.preventDefault();
    e.stopPropagation();
            ...
            "svg",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
                  ...
                  planets.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React$2.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: `planet-surface-${i}`, cx: "35%", cy: "30%", r: "65%", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: p2.colorSet.accent, stopOpacity: "0.9" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "50%", stopColor: p2.colorSet.base, stopOpacity: "0.85" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#0a0e18", stopOpacity: "0.7" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: `planet-atmo-${i}`, cx: "50%", cy: "50%", r: "50%", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "80%", stopColor: "transparent" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "92%", stopColor: p2.colorSet.glow }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "transparent" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("filter", { id: `planet-glow-${i}`, x: "-60%", y: "-60%", width: "220%", height: "220%", children: /* @__PURE__ */ jsxRuntimeExports.jsx("feGaussianBlur", { in: "SourceGraphic", stdDeviation: "8" }) })
                  ] }, `planet-defs-${i}`))
                ] }),
                  ...
                  "g",
                  {
                    ...
                    children: [
                      ...
                      planets.map((p2, i) => {
                        ...
                        const nameFontSize = Math.max(11, Math.min(16, p2.radius * 0.18)) / scaleFactor;
                        ...
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "g",
                          {
                            ...
                            onContextMenu: (e) => handleContextMenu(e, p2.node),
                            ...
                            style: { cursor: isDraggingRef.current ? "grabbing" : "pointer", opacity: draggedNode?.id === p2.node.id ? 0.4 : 1 },
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "circle",
                                {
                                  cx: p2.cx,
                                  cy: p2.cy,
                                  r: p2.radius + (dropTargetId === p2.node.id ? 12 : 6),
                                  fill: dropTargetId === p2.node.id ? "#fff" : p2.colorSet.glow,
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "circle",
                                {
                                  ...
                                  stroke: isHovered ? p2.colorSet.accent : "rgba(100,160,255,0.12)",
          ...
          hasChildren ? /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { clipPath: "url(#planet-clip)", filter: "url(#inner-shadow)", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { className: `voronoi-transition-group ${transitioning ? "voronoi-transition-group--entering" : "voronoi-transition-group--active"}`, children: [
              ...
              localLinks.map((link, idx) => {
                ...
                let opacity = 0.15;
                if (hoveredIndex === null) opacity = 0.35;
                else if (isFocus) opacity = 0.9;
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { style: { opacity, transition: "opacity 0.3s ease" }, className: "voronoi-local-link", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "path",
                    {
                      d: pathData,
...
function NavBar({ onSettings, onChangeVault, onCreateNote }) {
...
function SettingsPanel({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-overlay", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-panel", onClick: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "settings-label", children: t2.howToUse }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "instructions-list", children: [
